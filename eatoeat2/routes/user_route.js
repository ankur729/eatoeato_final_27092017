                ...
                db.user_infos.save({
                  ...
                  //  var message = "Dear " + req.body.user_name + " Welcome to eatoeato.com, don't forget to complete your details and enjoy ordering your food choice."
                    ...
                    // });
                      ...
                      db.sms_template_infos.find({ 'name': 'Signup Complete/ User' }, function (err, smstemplate_data) {


                        smstemplate = smstemplate_data[0].body.replace("^^FIRST_NAME^^", req.body.user_name);
                        console.log(smstemplate);

                        request("http://smsgate.idigitie.com/http-api.php?username=eatoeato&password=idid@1234&senderid=EATOET&route=1&number=" + to_no + "&message=" + smstemplate, function (error, response, body) {
                            if (!error && response.statusCode == 200) {
            ...
            for (var i = 0; i < cook_final_list_coll.length; i++) {
                ...
                for (var j = 0; j < cook_final_list_coll[i].food_details.length; j++) {
                    ...
                    if (cook_final_list_coll[i].food_details[j].food_isApproved == 'Approved' && cook_final_list_coll[i].food_details[j].food_status == 'Enable' && cook_final_list_coll[i].isDeactivate == 'false') {
                        ...
                        lat_long_obj.cook_latitude = cook_final_list_coll[i].cook_latitude;
                        lat_long_obj.cook_longitude = cook_final_list_coll[i].cook_longitude;
                        lat_long_obj.cook_company_name = cook_final_list_coll[i].cook_company_name;
             ...
             lat_long_coll = _.uniq(lat_long_coll, function (p) { return p.cook_latitude; });
                        ...
                        (function (s, uSize) {
                            ...
                            db.cook_infos.find({
                                ...
                                db.sms_template_infos.find({
                                    ...
                                    var cookname = cookdata[0].cook_name;
                                    var cooktoken = cookdata[0].token;
                                    var cookcontact = cookdata[0].cook_contact;
                                    var sms_body = tmp_sms_body;
                                        ...
                                        db.notification_infos.save(
                                            {
                                                ...
                                                sendMessageToUser(cooktoken, "Congratulations, You Received a New Order #" + id_arr[s], config.notificationTitleContent.notification_title_for_user_order_confirmed, config.notificationObj.notification_id_user_order_confirmed, 'data2');
